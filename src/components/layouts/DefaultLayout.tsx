...
export function DefaultLayout({ children }: Props) {
  ...
  return (
    <>
      <div
        id="stage"
        className="z-40 right-0 fixed h-screen overflow-hidden "
        style={{
      ...
      >
        ...
        <div className="z-50 VStack bg-white h-full">
          <div
            ...
            style={{
              visibility: isSafeAreaActive ? "hidden" : "visible",
              opacity: isSafeAreaActive ? 0 : 1,
              transition: "all 0.5s ease",
            }}
          >
            <svg
            ...
            >
              ...
              <g
                ...
                fillRule="evenodd"
              >
                <g id="Device" transform="translate(-720.000000, -240.000000)">
                  <g
                    id="display_fill"
        ...
        >
          <div id="PrimaryPanel" className=" VStack m-2 gap-4">
            <div className="HStack justify-between items-center">
              ...
              <div
                onClick={toggleSafeArea}
                className="p-2 rounded-md cursor-pointer hover:System-background-blue"
              >
                <svg
                  width="24px"
                  height="24px"
            ...
            >
              <div className="w-1/5 VStack justify-center">
              <BiSolidVideoPlus className="w-7 h-7" />
