    ...
    videos: [
      {
        ...
        thumbnail:"https://resizing.flixster.com/i7Txn-rTWv7B8aB5AYbe2IuLU6s=/ems.cHJkLWVtcy1hc3NldHMvbW92aWVzLzE0N2E1MDljLTNlZDEtNDIyMS1iZjgzLTJkMjU1NjRjNzEwMy5qcGc=",
    ...
    <>
      ...
      <div className="w-full h-full mt-2">
        <div className="flex flex-row w-full h-full mt-4">
          <p className="text-black font-bold text-4xl ml-6 mt-6 ">Videos</p>
          <div className=" w-5/6 h-5/6 text-lg">
            <div className="grid grid-cols-4 h-full w-full mt-20 ml-22 gap-4">
